...
export function Debt({ debtClass, debtsClass }: { debtClass: DebtClass; debtsClass: DebtsClass }) {
    return (
        <div className="bg-white shadow py-4 px-10 text-2xl flex items-center gap-[2.5vw] group/debt overflow-x-auto max-md:flex-col max-md:gap-5 max-md:items-start max-md:text-xl">
